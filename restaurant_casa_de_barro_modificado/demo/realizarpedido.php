...
mysql_query("UPDATE venta SET vTimbre = 1 WHERE vId=$idpedidomesa");
...
mysql_query("INSERT INTO venta (vCantidadProducto, vFecha, vIdpersona,vMesa,vObservacion,vTimbre) VALUES ('20','$fecha','$idpersona','$idmesa','$observacion','1')");
...
echo '<a onClick="abrir_ventana(\''.$topuno.'\'); return false;" href="#">';
/*echo '<script type="text/javascript">window.print();</script>';*/
echo "<script>document.location = 'impresion_ticketeraauto.php?id=$topuno';</script>";
...
<!--
function abrir_ventana(varid)
{
propiedades="width=400, height=500";
window.open("impresion_ticketeraauto.php?id="+varid,"_blank",propiedades);
}
//-->
</script>