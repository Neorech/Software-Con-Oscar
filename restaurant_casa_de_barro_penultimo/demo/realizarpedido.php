<?
	...
	if ($idmesaestado==1) {
		...
		foreach ($_SESSION["arr"] as $valor) {
			...
			mysql_query("UPDATE venta SET vTimbre = 1, vFecha ='$fecha' WHERE vId=$idpedidomesa");


			mysql_query("INSERT INTO venta_detalle(vId,vd_idProducto, vd_Cantidad, vd_Costo) VALUES
												('$idpedidomesa','".$valor['id']."','".$valor['cantidad']."','".$valor['costo']."')");
