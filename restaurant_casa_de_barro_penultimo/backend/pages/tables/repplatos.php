    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            PLATOS
            <small>Reporte de platos</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Reportes</a></li>
            <li class="active">Reporte de Platos</li>
          </ol>
        </section>
...
<script>
				  ...
				  {
				  //alert('impresion');
				  window.open("reporte_imp/platos.php?ifecha="+ifecha+"&ffecha="+ffecha+"","VENTAS","width=900,height=600")
...
<a onclick="javascript:impresionfecha('<? echo $_GET['ifecha'];?>','<? echo $_GET['ffecha'];?>'); return false;" href="#"> <img width="40" height="40" alt="Buscar" src="../images/printer.png"></a>
                ...
                <div class="box-header">
                  <h3 class="box-title">Reporte de los platos vendidos</h3>
                  <div class="box-tools">
