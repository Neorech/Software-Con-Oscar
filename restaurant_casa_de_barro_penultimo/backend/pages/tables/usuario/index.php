  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="../../index2.html" class="logo"><b>El Conquistador</b></a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../../../demo/imagenes/persona/<? echo $_SESSION["pimagen"];  ?>" class="img-circle" alt="User Image" />
            </div>
		...
		echo   $_SESSION["pernombres"].' '.$_SESSION["perapellidos"];
		//echo   $_SESSION["perapellidos"];
		//echo   $_SESSION["palias"];
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Ventas
            <small>Administracion Ventas</small>
          </h1>
          <ol class="breadcrumb">
...
<div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <!--<input name="ifecha" type="datetime" />
                  <input name="ffecha789" type="datetime" />
                  <input type="datetime" name="fecha">
                  <input type="date" name="fecha" min="2013-01-01T00:00Z">
                  <input type="date" name="ifecha" step="1" min="2013-01-01" max="2013-12-31" value="<?php echo date("Y-m-d");?>">
                  -->
...
<script>
				  ...
				  {
				  //alert('impresion');
				  window.open("../../../demo/reporte_imp/caja.php?ifecha="+ifecha+"&ffecha="+ffecha+"","VENTAS","width=900,height=600")
  ...
  function busquedafecha()
{
	...
	location.href="data.php?ifecha="+inicio+"&ffecha="+fin
