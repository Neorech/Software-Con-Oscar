  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="../../index2.html" class="logo"><b>Casa de Barro</b></a>
...
<script>
				  ...
				  {
				  //alert('impresion');
				  window.open("reporte_imp/caja.php?ifecha="+ifecha+"&ffecha="+ffecha+"","VENTAS","width=900,height=600")
				  //window.open("pagina.html","miventana","width=900,height=200,menubar=no")
				  }
				  function impresionfechadia(ifecha,ffecha)
				  {
				  //alert('impresion');
				  window.open("reporte_imp/cajafecha.php?ifecha="+ifecha+"&ffecha="+ffecha+"","VENTAS","width=900,height=600")
				  //window.open("pagina.html","miventana","width=900,height=200,menubar=no")
				  }
                  </script>
                  <script> 
...
<a onclick="javascript:impresionfechadia('<? echo $_GET['ifecha'];?>','<? echo $_GET['ffecha'];?>'); return false;" href="#"> Reporte Costo Diario<img width="40" height="40" alt="Buscar" src="../images/printer.png"></a>
