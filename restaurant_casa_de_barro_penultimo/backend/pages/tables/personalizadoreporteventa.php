...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Reporte de Almacen por Días</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Almacén por Días
            <small>Administracion Almacén</small>
          </h1>
          <ol class="breadcrumb">
...
<script>
                  function impresionfecha(ifecha)
				  {
				  //alert('impresion');
				  window.open("reporte_imp/venta_diaria.php?ifecha="+ifecha,"VENTAS","width=900,height=600")
...
<a onclick="javascript:impresionfecha('<? echo $_GET['ifecha'];?>'); return false;" href="#"> <img width="40" height="40" alt="Buscar" src="../images/printer.png"></a>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      -->
					  <? 
					  include 'Venta_personalizado.php' 
